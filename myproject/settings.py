...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-1cza5t484x$lj4m7r(q)02&quubtgimj9u-u*ql^zfs(_^=k(k')
...
# Always ensure localhost, 127.0.0.1 and the Render domain are allowed
